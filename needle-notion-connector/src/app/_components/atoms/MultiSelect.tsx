...
import { popAt } from "~/utils/array-utils";
import { debounce } from "~/utils/function-utils";
import { Input } from "./Input";
import { useEffectSkipFirst } from "~/app/hooks";
  ...
  return (
    <div>
      ...
      >
        ...
        {isOpen && (
          <div className="animate-showSlow absolute -bottom-2 left-0 z-10 max-h-48 w-full min-w-64 translate-y-full overflow-y-auto rounded border bg-white shadow-sm hover:cursor-pointer dark:border-zinc-800 dark:bg-zinc-950">
            <Input
              ref={searchRef}
              value={searchTerm}
            ...
            {filteredItems.map((item) => {
              ...
              const handleClick = isSelected
                ? () => {} //setSelectedItems(popAt(selectedItems, index)) // This creates an infinite loop
